...
- [x] **Persistência de Dados :** Salvar e ler os dados em arquivos binários. Salvar os dados antes de encerrar o programa. O programa tem que salvar o último id_total.
