...
3. **Lista Estática (Turma de alunos):** Com capacidade máxima de 50 alunos (conforme o limite de vagas físicas).
...
- Arquivo de banco de dados com as informações dos alunos.
